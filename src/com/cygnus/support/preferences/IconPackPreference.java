...
public class IconPackPreference extends Preference {
    ...
    private void setNone() {
        ...
        setSummary(getContext().getResources().getString(R.string.default_title));
    }
    ...
    private static class IconAdapter extends BaseAdapter {
        ...
        IconAdapter(Context context, Map<String, IconPackInfo> supportedPackages, String currentPack) {
            ...
            String defaultLabel = context.getResources().getString(R.string.default_title);
